...
* PhD thesis: [A Declarative Debugger for Haskell]($root/docs/BerniePope.PhD.Thesis.pdf). Completed December 2006. 
...
* Honours thesis: [Buddha: A Declarative Debugger for Haskell]($root/docs/BerniePope.Hons.Thesis.pdf). Completed June 1998. 
...
* [Monadic Parsing: A Case Study]($root/docs/monad_parse.pdf). Co-authored with Mark Wielaard and Simon Taylor. 
...
* [Haskell for Miranda Programmers]($root/docs/mira2hask.pdf). Co-authored with Kevin Glynn. 
...
* [A tour of the Haskell Prelude]($root/docs/haskell.tour.tar.gz). A guide to the functions, operators and classes of the Haskell 98 Prelude.
...
* [Specialisation of Higher-Order Functions for Debugging]($root/docs/specialise.pdf). Co-authored with Lee Naish.
    ...
    [Slides for my talk at WFLP 01]($root/docs/spec.talk.pdf).

* [Reification in Haskell (draft)]($root/docs/reify.pdf) Co-authored with Lee Naish.
    ...
    [Slides for my talk at IFL 01]($root/docs/reify.talk.pdf).

* [A program transformation for Declarative Debugging (draft)]($root/docs/pope.naish.apepm.pdf) Co-authored with Lee Naish.
...
* [A program transformation for debugging Haskell 98]($root/docs/acsc.pdf). Co-authored with Lee Naish, presented at ACSC 2003.
...
* [Practical Aspects of Declarative Debugging in Haskell 98]($root/docs/PopeNaishPPDP.pdf). Co-authored with Lee Naish, presented at PPDP 2003.
...
* [Declarative Debugging with buddha]($root/docs/Afp.pdf). In Varmo Vene and Tarmo Uustalu, editors, Advanced Functional Programming, 5th International School, AFP 2004, volume 3622 of Lecture Notes in Computer Science, pages 331-357. Springer Verlag, September 2005.
    ...
    Slides for the talk are available: [Set 1]($root/docs/Afp.slides1.pdf), [Set 2]($root/docs/Afp.slides2.pdf) and [Set 3]($root/docs/Afp.slides3.pdf).
...
* [A Lightweight Interactive Debugger for Haskell]($root/docs/ghci-debug.pdf). Co-authored with Simon Marlow, Jose Iborra, and Andy Gill. The Haskell Workshop 2007, June 2007.
...
* [Step inside the GHCi debugger](http://ww2.cs.mu.oz.au/~bjpop/papers/ghci-debug.monad.reader.pdf). A tutorial in Issue 10 of the Monad Reader online Haskell magazine. April 2008.
...
* [Bibtex entries for some of my papers]($root/docs/bibtex.txt).

## Slides

* [Static Pattern Calculus]($root/docs/static_pattern_calculus.pdf). Presented at the Melbourne FPU, Friday 22 January 2010.
...
* [Monads in Scala]($root/docs/scala_monads.pdf). Presented at the Melbourne Scala Users Group, Monday 26 October 2009.
...
* [Parser combinators in Scala]($root/docs/scala_parser_combinators.pdf). Presented at the Melbourne Scala Users Group, Monday 22 June 2009.
...
* [Continuations]($root/docs/continuations.pdf). Presented at the Melbourne FPU, Friday 3 October 2008.
...
* [Applicative Functors]($root/docs/applicative.pdf). Presented at the Melbourne FPU, Friday 3 July 2009.
...
* [Simple graph reduction with visualisation]($root/docs/graphreduction.pdf). Presented at the Melbourne FPU, Friday 12 May 2009.
...
* [Stack tracing in Haskell - an exploration of the design space]($root/docs/stack_tracing.pdf). Presented at the Haskell Implementors Workshop, Saturday 5 2009, Edinburgh, Scotland.
...
* [Fixed points]($root/docs/fixed_points.txt).
...
* [The Scott Encoding of data types into the lambda calculus]($root/docs/scott_encoding.txt).
...
* [The Pure Lambda Calculus]($root/docs/pure_lambda_calculus.txt).
...
* [Monad Transformers]($root/docs/MonadTransformers.lhs).
...
* [Indexing for fast search in Python]($root/docs/indexing.pdf).
...
* [Binary search trees in Python]($root/docs/binary_search_trees.pdf).
...
* [Recursion in Python]($root/docs/recursion.pdf).
...
* [HTML forms - a user interface to CGI applications]($root/docs/htmlforms.pdf).
...
* [A Haskell quiz]($root/docs/haskell_quiz.pdf).

    Test your knowledge of Haskell in this quiz.

* [A Lambda Calculus quiz]($root/docs/lambda_calculus_quiz.pdf).

    Test your knowledge of the Lambda Calculus in this quiz.

* [Ninety nine bottles of beer on the wall - a study in repetition]($root/docs/Ninety_nine_bottles_of_beer_on_the_wall_.pdf).
